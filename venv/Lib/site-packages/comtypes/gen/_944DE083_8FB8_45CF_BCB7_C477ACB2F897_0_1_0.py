...
__all__ = [
    'UIA_AutomationIdPropertyId', 'IUIAutomationElement8',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_IsStylesPatternAvailablePropertyId',
    'UIA_NavigationLandmarkTypeId', 'IUIAutomationStylesPattern',
    'TreeScope_Ancestors', 'UIA_ComboBoxControlTypeId',
    'IUIAutomationPropertyChangedEventHandler',
    'SupportedTextSelection_Single', 'UIA_FlowsFromPropertyId',
    'HeadingLevel4', 'ProviderOptions_OverrideProvider',
    'UIA_SelectionActiveEndAttributeId', 'CUIAutomation8',
    'UIA_SelectionSelectionPropertyId', 'AnnotationType_Author',
    'UIA_InputReachedOtherElementEventId', 'RowOrColumnMajor',
    'WindowVisualState_Normal', 'ExpandCollapseState',
    'UIA_IsDialogPropertyId', 'UIA_DataGridControlTypeId',
    'StyleId_Subtitle', 'UIA_OverlineColorAttributeId',
    'SupportedTextSelection_Multiple', 'DockPosition_Bottom',
    'ProviderOptions_UseClientCoordinates', 'SupportedTextSelection',
    'PropertyConditionFlags_IgnoreCase',
    'UIA_VisualEffectsPropertyId',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'HeadingLevel2', 'IUIAutomationAndCondition', 'TextUnit_Format',
    'NavigateDirection_PreviousSibling', 'AnnotationType_Endnote',
    'UIA_IsDragPatternAvailablePropertyId',
    'IUIAutomationScrollItemPattern', 'StyleId_NumberedList',
    'HeadingLevel5', 'ProviderOptions_ProviderOwnsSetFocus',
    'UIA_TextFlowDirectionsAttributeId', 'TreeScope_Descendants',
    'UIA_StylesShapePropertyId', 'UIA_ScrollBarControlTypeId',
    ...
    'UIA_Transform2CanZoomPropertyId', 'UIA_LinkAttributeId',
    'StyleId_Emphasis', 'StructureChangeType_ChildrenBulkAdded',
    'HeadingLevel6', 'AnnotationType_Header', 'TextUnit', 'TreeScope',
    'UIA_StylesFillPatternStylePropertyId',
    'UIA_DropTargetDropTargetEffectPropertyId', 'ExtendedProperty',
    'IUIAutomationNotCondition', 'NotificationKind_ItemAdded',
    'IUIAutomationGridPattern',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_ToolBarControlTypeId', 'ExpandCollapseState_Expanded',
    'AnnotationType_AdvancedProofingIssue',
    'UIA_TableRowOrColumnMajorPropertyId',
    'UIA_WindowCanMaximizePropertyId', 'UIA_ImageControlTypeId',
    'WindowInteractionState_Running', 'ScrollAmount_NoAmount',
    ...
    'UIA_MarginBottomAttributeId', 'UIA_TextPatternId',
    'UIA_MenuModeEndEventId', 'UIA_RadioButtonControlTypeId',
    'UIA_IsContentElementPropertyId',
    'UIA_IsDataValidForFormPropertyId', 'IUIAutomation',
    'ExpandCollapseState_LeafNode', 'UIA_SystemAlertEventId',
    'IUIAutomation4', 'UIA_Window_WindowOpenedEventId',
    'UIA_RotationPropertyId', 'UIA_MarginLeadingAttributeId',
    'AnnotationType_ConflictingChange',
    'SynchronizedInputType_LeftMouseDown',
    'UIA_GridItemRowPropertyId', 'UIA_DropTargetPatternId',
    'RowOrColumnMajor_ColumnMajor',
    'UIA_RangeValueIsReadOnlyPropertyId',
    'NotificationKind_ItemRemoved', 'UIA_TextEditPatternId',
    'UIA_RuntimeIdPropertyId', 'IUIAutomation6',
    'IUIAutomationEventHandlerGroup', 'UIA_CustomControlTypeId',
    'UIA_BulletStyleAttributeId', 'TextUnit_Line',
    'UIA_IsKeyboardFocusablePropertyId', 'UIA_SizePropertyId',
    'UIA_FillColorPropertyId', 'IUIAutomationElement6',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'UIA_FontWeightAttributeId', 'AutomationElementMode_None',
    'NavigateDirection',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'IUIAutomationVirtualizedItemPattern', 'UIA_TabControlTypeId',
    'UIA_LegacyIAccessibleRolePropertyId',
    'IUIAutomationGridItemPattern', 'UIA_MarginTopAttributeId',
    'ProviderOptions_NonClientAreaProvider', 'StyleId_BulletedList',
    'UIA_SearchLandmarkTypeId', 'UIA_IsEnabledPropertyId',
    'DockPosition_Right', 'StructureChangeType_ChildAdded',
    'UIA_AriaRolePropertyId', 'UIA_SplitButtonControlTypeId',
    'UIA_CaretBidiModeAttributeId', 'CoalesceEventsOptions',
    'UIA_MarginTrailingAttributeId', 'UIA_SummaryChangeId',
    'IUIAutomation2', 'ConnectionRecoveryBehaviorOptions_Enabled',
    'UIA_HyperlinkControlTypeId', 'IUIAutomationProxyFactory',
    'IUIAutomationProxyFactoryMapping', 'TreeScope_Children',
    'IUIAutomationCacheRequest', 'UIA_AnnotationObjectsAttributeId',
    'StyleId_Heading1',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'IUIAutomationCustomNavigationPattern', 'IUIAutomationTextRange',
    'UIA_WindowWindowVisualStatePropertyId',
    'AnnotationType_MoveChange', 'UIA_IsSubscriptAttributeId',
    'UIA_TogglePatternId', 'UIA_AnnotationObjectsPropertyId',
    'UIA_GridItemColumnSpanPropertyId', 'UIA_StyleNameAttributeId',
    'AnnotationType_FormatChange', 'UIA_ClickablePointPropertyId',
    'UIA_IsRequiredForFormPropertyId',
    'StructureChangeType_ChildrenReordered', 'UIA_FillTypePropertyId',
    'TextUnit_Document', 'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_TransformCanMovePropertyId', 'UIA_DropTarget_DroppedEventId',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'UIA_LegacyIAccessiblePatternId', 'UIA_GroupControlTypeId',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'DockPosition_Fill', 'UIA_RangeValueMaximumPropertyId',
    'IUIAutomationOrCondition',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_CustomNavigationPatternId',
    'UIA_IndentationLeadingAttributeId',
    'UIA_IsTransformPattern2AvailablePropertyId',
    'UIA_CalendarControlTypeId', 'UIA_Window_WindowClosedEventId',
    'IUIAutomationStructureChangedEventHandler',
    'UIA_InputReachedTargetEventId', 'UIA_FormLandmarkTypeId',
    'IUIAutomationPropertyCondition', 'UIA_SeparatorControlTypeId',
    'IUIAutomationWindowPattern', 'UIA_AccessKeyPropertyId',
    'ExpandCollapseState_PartiallyExpanded', 'StyleId_Heading9',
    'IAccessible', 'UIA_IsDockPatternAvailablePropertyId',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'UIA_ValueValuePropertyId',
    'UIA_IsTextPatternAvailablePropertyId',
    'UIA_IsWindowPatternAvailablePropertyId', 'UIA_ValuePatternId',
    'UIA_DragPatternId', 'RowOrColumnMajor_RowMajor',
    'SynchronizedInputType_RightMouseUp',
    'AnnotationType_GrammarError', 'UIA_ForegroundColorAttributeId',
    'AnnotationType_SpellingError', 'UIA_BoundingRectanglePropertyId',
    'UIA_ControlTypePropertyId', 'UIA_IsSuperscriptAttributeId',
    'UIA_AnnotationAuthorPropertyId', 'AutomationElementMode',
    'HeadingLevel7', 'UIA_CheckBoxControlTypeId',
    'UIA_GridColumnCountPropertyId',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'IUIAutomationInvokePattern', 'WindowVisualState',
    'UIA_AsyncContentLoadedEventId', 'IUIAutomationAnnotationPattern',
    'UIA_HeaderControlTypeId', 'UIA_Drag_DragCancelEventId',
    'AnnotationType_Footer', 'UIA_StylesStyleIdPropertyId',
    'OrientationType_None', 'IUIAutomationBoolCondition',
    'SynchronizedInputType_KeyUp', 'UIA_BackgroundColorAttributeId',
    ...
    'AnnotationType_Sensitive', 'IUIAutomationTextPattern2',
    'NotificationProcessing_ImportantMostRecent',
    'IUIAutomationElement3', 'UIA_AriaPropertiesPropertyId',
    'UIA_StructureChangedEventId', 'ZoomUnit_SmallIncrement',
    'UIA_AnnotationTypesAttributeId',
    'IUIAutomationSynchronizedInputPattern',
    'UIA_Drag_DragStartEventId', 'UIA_FrameworkIdPropertyId',
    'NavigateDirection_Parent', 'UIA_Invoke_InvokedEventId',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'UIA_IsActiveAttributeId', 'UIA_IsHiddenAttributeId',
    'UIA_SayAsInterpretAsMetadataId',
    'NotificationProcessing_MostRecent', 'UIA_MenuControlTypeId',
    'UIA_DragDropEffectPropertyId', 'AnnotationType_UnsyncedChange',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'UIA_OutlineThicknessPropertyId', 'UIA_TextPattern2Id',
    'TreeScope_None', 'ProviderOptions_HasNativeIAccessible',
    ...
    'UIA_FontSizeAttributeId', 'UIA_WindowControlTypeId',
    'IUIAutomationElementArray', 'TextUnit_Page',
    'ConnectionRecoveryBehaviorOptions',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'UIA_TableRowHeadersPropertyId', 'IUIAutomation3',
    'UIA_OptimizeForVisualContentPropertyId',
    'UIA_DragIsGrabbedPropertyId', 'UIA_DockPatternId',
    'IUIAutomationValuePattern',
    'WindowInteractionState_ReadyForUserInteraction',
    'IUIAutomationEventHandler', 'UIA_DescribedByPropertyId',
    'UIA_DragGrabbedItemsPropertyId', 'UIA_IsPasswordPropertyId',
    'StyleId_Heading5', 'UIA_LandmarkTypePropertyId',
    'IUIAutomationTextEditTextChangedEventHandler',
    'UIA_UnderlineStyleAttributeId',
    'UIA_IsTextPattern2AvailablePropertyId',
    'UIA_TableColumnHeadersPropertyId',
    'IUIAutomationTableItemPattern', 'IUIAutomationElement7',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'IUIAutomationTreeWalker', 'ProviderOptions_ClientSideProvider',
    'PropertyConditionFlags_None',
    'UIA_LegacyIAccessibleHelpPropertyId',
    'WindowInteractionState_Closing', 'UIA_HeaderItemControlTypeId',
    'UIA_LayoutInvalidatedEventId', 'TreeTraversalOptions_PostOrder',
    'TextUnit_Word', 'IUIAutomationSpreadsheetPattern',
    'IUIAutomationTextRange2', 'UIA_ClassNamePropertyId',
    'UIA_ScrollHorizontalScrollPercentPropertyId', 'ToggleState_On',
    'UIA_PositionInSetPropertyId',
    'UIA_ActiveTextPositionChangedEventId', 'IUIAutomationElement',
    'UIA_ItemContainerPatternId', 'ZoomUnit_SmallDecrement',
    ...
    'TreeScope_Parent', 'TreeTraversalOptions_LastToFirstOrder',
    'PropertyConditionFlags', 'IUIAutomationTextRange3',
    'UIA_TransformCanResizePropertyId', 'UIA_InputDiscardedEventId',
    'Polite', 'StyleId_Heading6', 'StyleId_Heading8', 'LiveSetting',
    'IUIAutomationDropTargetPattern', 'StyleId_Heading7',
    'UIA_NotificationEventId', 'UIA_Selection2ItemCountPropertyId',
    'UIA_Drag_DragCompleteEventId',
    'UIA_AfterParagraphSpacingAttributeId',
    'NavigateDirection_NextSibling', 'SupportedTextSelection_None',
    'UIA_TreeItemControlTypeId', 'DockPosition_Left',
    'UIA_Text_TextChangedEventId',
    'UIA_BeforeParagraphSpacingAttributeId', 'StyleId_Heading3',
    'UIA_DataItemControlTypeId', 'UIA_GridPatternId', 'ToggleState',
    'UIA_OutlineColorPropertyId', 'UIA_PaneControlTypeId',
    'UIA_LabeledByPropertyId', 'ScrollAmount',
    'CoalesceEventsOptions_Disabled',
    'StructureChangeType_ChildrenBulkRemoved',
    'UIA_FullDescriptionPropertyId', 'StyleId_Normal',
    'UIA_MainLandmarkTypeId', 'UIA_TabsAttributeId', 'UiaChangeInfo',
    'IUIAutomationRangeValuePattern',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'ScrollAmount_LargeDecrement', 'UIA_OutlineStylesAttributeId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_TextControlTypeId', 'UIA_MenuModeStartEventId',
    'UIA_MenuItemControlTypeId', 'UIA_ProcessIdPropertyId',
    'UIA_CulturePropertyId', 'DockPosition', 'IUIAutomationElement5',
    'ProviderOptions', 'UIA_LegacyIAccessibleSelectionPropertyId',
    'UIA_StylesFillColorPropertyId', 'UIA_StylesPatternId',
    'UIA_StyleIdAttributeId', 'StyleId_Quote',
    'TreeTraversalOptions_Default', 'UIA_DocumentControlTypeId',
    'AnnotationType_Comment', 'SynchronizedInputType',
    ...
    'WindowInteractionState_NotResponding', 'UIA_TransformPattern2Id',
    'UIA_TableItemPatternId', 'HeadingLevel_None',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'UIA_LiveSettingPropertyId', 'IUIAutomationElement9',
    'NotificationKind', 'NotificationKind_ActionCompleted',
    'UIA_TreeControlTypeId', 'IUIAutomationTextPattern',
    'ZoomUnit_LargeDecrement', 'IRawElementProviderSimple',
    'UIA_Transform2ZoomMinimumPropertyId',
    'IUIAutomationNotificationEventHandler', 'TextUnit_Paragraph',
    'UIA_Text_TextSelectionChangedEventId', 'StyleId_Title',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'UIA_IsTextEditPatternAvailablePropertyId',
    'ConnectionRecoveryBehaviorOptions_Disabled', 'StyleId_Heading4',
    'UIA_HelpTextPropertyId', 'UIA_ToolTipOpenedEventId',
    'IUIAutomationTextRangeArray', 'AnnotationType_DeletionChange',
    'UIA_SelectionItem_ElementSelectedEventId', 'UIA_LevelPropertyId',
    'CUIAutomation', 'UIA_ItemStatusPropertyId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'UIA_IndentationTrailingAttributeId', 'UIA_InvokePatternId',
    'TreeScope_Element', 'UIA_AppBarControlTypeId',
    'UIA_ScrollPatternId', 'UIA_ButtonControlTypeId',
    ...
    'UIA_TabItemControlTypeId', 'IUIAutomationTablePattern',
    'UIA_DropTarget_DragEnterEventId',
    'ExpandCollapseState_Collapsed', 'UIA_VirtualizedItemPatternId',
    'SynchronizedInputType_KeyDown', 'ScrollAmount_SmallDecrement',
    ...
    'UIA_TitleBarControlTypeId', 'UIA_MenuBarControlTypeId',
    'UIA_AcceleratorKeyPropertyId', 'UIA_WindowIsTopmostPropertyId',
    'UIA_EditControlTypeId', 'UIA_DockDockPositionPropertyId',
    'UIA_Transform2ZoomMaximumPropertyId',
    'UIA_LiveRegionChangedEventId',
    'UIA_StrikethroughStyleAttributeId',
    'UIA_LegacyIAccessibleNamePropertyId', 'HeadingLevel8',
    'IUIAutomationDragPattern', 'UIA_SpreadsheetItemPatternId',
    'UIA_HorizontalTextAlignmentAttributeId',
    'AnnotationType_TrackChanges', 'UIA_IsReadOnlyAttributeId',
    'IUIAutomationTogglePattern', 'UIA_GridItemPatternId',
    'UIA_SelectionPattern2Id', 'UIA_IndentationFirstLineAttributeId',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_ExpandCollapsePatternId', 'UIA_AnnotationPatternId',
    'IUIAutomationChangesEventHandler',
    'TextEditChangeType_CompositionFinalized',
    'UIA_Transform2ZoomLevelPropertyId',
    'UIA_IsControlElementPropertyId',
    'UIA_IsGridPatternAvailablePropertyId', 'ZoomUnit',
    'UIA_ChangesEventId', 'IUIAutomationScrollPattern',
    'IUIAutomationDockPattern', 'WindowVisualState_Minimized',
    'TextPatternRangeEndpoint', 'AnnotationType_EditingLockedChange',
    'UIA_CaretPositionAttributeId', 'UIA_ProgressBarControlTypeId',
    'IUIAutomationElement4', 'TextEditChangeType_AutoCorrect',
    ...
    'UIA_ItemTypePropertyId', 'StructureChangeType',
    'UIA_NativeWindowHandlePropertyId', 'UIA_CapStyleAttributeId',
    'OrientationType', 'AnnotationType_ExternalChange',
    'SynchronizedInputType_RightMouseDown',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_ObjectModelPatternId', 'UIA_SelectionItemPatternId',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'NotificationKind_Other', 'AnnotationType_FormulaError',
    'UIA_ValueIsReadOnlyPropertyId', 'HeadingLevel3',
    'TextUnit_Character', 'IUIAutomationProxyFactoryEntry',
    'SynchronizedInputType_LeftMouseUp', 'UIA_ToolTipClosedEventId',
    'UIA_IsItalicAttributeId', 'IUIAutomationObjectModelPattern',
    'IUIAutomationTransformPattern2',
    'UIA_MultipleViewCurrentViewPropertyId',
    'AnnotationType_CircularReferenceError',
    'ScrollAmount_LargeIncrement', 'UIA_LineSpacingAttributeId',
    'UIA_ThumbControlTypeId', 'UIA_ScrollVerticalViewSizePropertyId',
    'UIA_LocalizedLandmarkTypePropertyId', 'UIA_CultureAttributeId',
    'UIA_CustomLandmarkTypeId',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'ToggleState_Off', 'OrientationType_Vertical',
    'UIA_AnnotationTargetPropertyId',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'UIA_ListControlTypeId', 'IUIAutomation5',
    'UIA_MenuClosedEventId', 'IUIAutomationCondition',
    'UIA_SemanticZoomControlTypeId', 'AnnotationType_Unknown',
    'UIA_FlowsToPropertyId', 'UIA_AnimationStyleAttributeId',
    'UIA_SelectionItemIsSelectedPropertyId', 'UIA_TransformPatternId',
    'UIA_ListItemControlTypeId', 'NotificationProcessing',
    'UIA_LegacyIAccessibleValuePropertyId', 'Assertive',
    'ProviderOptions_RefuseNonClientSupport',
    'UIA_StrikethroughColorAttributeId',
    'UIA_HasKeyboardFocusPropertyId', 'UIA_DragDropEffectsPropertyId',
    'TreeTraversalOptions', 'IUIAutomationSelectionPattern',
    'UIA_FontNameAttributeId', 'NavigateDirection_LastChild',
    'IUIAutomationItemContainerPattern',
    'TextPatternRangeEndpoint_Start', 'TextPatternRangeEndpoint_End',
    'UIA_TextEdit_TextChangedEventId', 'AutomationElementMode_Full',
    'UIA_ScrollItemPatternId', 'AnnotationType_Highlighted',
    'IUIAutomationElement2', 'WindowInteractionState',
    'StructureChangeType_ChildRemoved', 'StyleId_Heading2',
    'NotificationKind_ActionAborted',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'TextEditChangeType_None', 'UIA_TransformCanRotatePropertyId',
    'ProviderOptions_ServerSideProvider', 'DockPosition_Top',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'UIA_WindowIsModalPropertyId',
    'UIA_IsInvokePatternAvailablePropertyId',
    'OrientationType_Horizontal',
    'WindowInteractionState_BlockedByModalWindow', 'HeadingLevel9',
    'UIA_RangeValueSmallChangePropertyId',
    'ScrollAmount_SmallIncrement',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'UIA_MultipleViewPatternId', 'UIA_AutomationFocusChangedEventId',
    'UIA_ControllerForPropertyId', 'UIA_SpreadsheetPatternId',
    'UIA_RangeValuePatternId', 'DockPosition_None',
    'CoalesceEventsOptions_Enabled',
    'UIA_IsValuePatternAvailablePropertyId',
    'ToggleState_Indeterminate', 'TreeScope_Subtree',
    'UIA_SpinnerControlTypeId', 'ZoomUnit_NoAmount',
    'UIA_SizeOfSetPropertyId', 'UIA_IsPeripheralPropertyId',
    'AnnotationType_InsertionChange', 'UIA_SliderControlTypeId',
    'TextEditChangeType', 'UIA_TablePatternId',
    'UIA_StylesFillPatternColorPropertyId', 'StyleId_Custom',
    'UIA_WindowPatternId', 'NotificationProcessing_All',
    'UIA_CenterPointPropertyId', 'ZoomUnit_LargeIncrement',
    'UIA_StatusBarControlTypeId', 'UIA_TextChildPatternId',
    'IUIAutomationSelectionPattern2', 'HeadingLevel1',
    'UIA_NamePropertyId', 'UIA_ToggleToggleStatePropertyId',
    'IUIAutomationSelectionItemPattern', 'UIA_MenuOpenedEventId',
    'IUIAutomationLegacyIAccessiblePattern',
    'UIA_OverlineStyleAttributeId',
    'IUIAutomationMultipleViewPattern',
    'UIA_IsTablePatternAvailablePropertyId',
    'WindowVisualState_Maximized', 'UIA_GridRowCountPropertyId',
    'UIA_HeadingLevelPropertyId',
    'IUIAutomationExpandCollapsePattern',
    'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_TableControlTypeId', 'TextEditChangeType_Composition',
    'NavigateDirection_FirstChild', 'ProviderOptions_UseComThreading',
    'AnnotationType_Footnote',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'UIA_LocalizedControlTypePropertyId'
]

_check_version('1.1.14', 1652269928.544719)
